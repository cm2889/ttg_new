        ...
        <section className="relative min-h-[20vh] overflow-hidden bg-[#f5f7f8] lg:min-h-[40vh]">
            <Container className="relative z-10 flex flex-col items-center justify-center gap-6 py-6 sm:gap-12 sm:py-12">
                ...
                <div className="relative w-full overflow-hidden">
                    <div className="pointer-events-none absolute inset-y-0 left-0 z-20 w-8 bg-linear-to-r from-white to-transparent md:w-16" />
                    <div className="pointer-events-none absolute inset-y-0 right-0 z-20 w-8 bg-linear-to-l from-white to-transparent md:w-16" />
